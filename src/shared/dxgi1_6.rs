...
use crate::shared::dxgi1_2::{
    DXGI_COMPUTE_PREEMPTION_GRANULARITY, DXGI_GRAPHICS_PREEMPTION_GRANULARITY,
};
use crate::shared::dxgi1_4::{IDXGIAdapter3, IDXGIAdapter3Vtbl};
use crate::shared::dxgi1_5::{IDXGIFactory5, IDXGIFactory5Vtbl, IDXGIOutput5, IDXGIOutput5Vtbl};
use crate::shared::dxgitype::{DXGI_COLOR_SPACE_TYPE, DXGI_MODE_ROTATION};
use crate::shared::guiddef::REFIID;
use crate::shared::minwindef::{BOOL, FLOAT, UINT};
use crate::shared::windef::{HMONITOR, RECT};
use crate::um::winnt::{HRESULT, LUID, WCHAR};
