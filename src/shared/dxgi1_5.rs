...
use crate::shared::basetsd::UINT16;
use crate::shared::dxgi::IDXGIResource;
use crate::shared::dxgi1_2::{DXGI_OFFER_RESOURCE_PRIORITY, IDXGIOutputDuplication};
use crate::shared::dxgi1_3::{IDXGIDevice3, IDXGIDevice3Vtbl};
use crate::shared::dxgi1_4::{
    IDXGIFactory4, IDXGIFactory4Vtbl, IDXGIOutput4, IDXGIOutput4Vtbl, IDXGISwapChain3,
    IDXGISwapChain3Vtbl,
};
use crate::shared::dxgiformat::DXGI_FORMAT;
use crate::shared::minwindef::UINT;
