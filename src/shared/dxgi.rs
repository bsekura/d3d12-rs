...
use crate::shared::basetsd::{SIZE_T, UINT64};
use crate::shared::dxgiformat::DXGI_FORMAT;
use crate::shared::dxgitype::{
    DXGI_GAMMA_CONTROL, DXGI_GAMMA_CONTROL_CAPABILITIES, DXGI_MODE_DESC, DXGI_MODE_ROTATION,
    DXGI_SAMPLE_DESC, DXGI_USAGE,
};
use crate::shared::guiddef::{REFGUID, REFIID};
use crate::shared::minwindef::{BOOL, BYTE, DWORD, FLOAT, HMODULE, UINT};
use crate::shared::windef::{HDC, HMONITOR, HWND, RECT};
use crate::um::unknwnbase::{IUnknown, IUnknownVtbl};
use crate::um::winnt::{HANDLE, HRESULT, INT, LARGE_INTEGER, LUID, WCHAR};
