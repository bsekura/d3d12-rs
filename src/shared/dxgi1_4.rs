...
use crate::shared::basetsd::UINT64;
use crate::shared::dxgi1_2::{IDXGIAdapter2, IDXGIAdapter2Vtbl};
use crate::shared::dxgi1_3::{
    IDXGIFactory3, IDXGIFactory3Vtbl, IDXGIOutput3, IDXGIOutput3Vtbl, IDXGISwapChain2,
    IDXGISwapChain2Vtbl,
};
use crate::shared::dxgiformat::DXGI_FORMAT;
use crate::shared::dxgitype::DXGI_COLOR_SPACE_TYPE;
use crate::shared::guiddef::REFGUID;
use crate::shared::minwindef::{DWORD, UINT};
use crate::um::unknwnbase::IUnknown;
use crate::um::winnt::{HANDLE, HRESULT, LUID};
